...
output "resource_group" { value = azurerm_resource_group.azure-rg.id }
...
output "azurerm_route" { value = azurerm_route.route-internet.id }
output "lan_subnet" { value = azurerm_subnet.subnet-lan.id }
output "mgmt_subnet" { value = azurerm_subnet.subnet-mgmt.id }
output "wan_subnet" { value = azurerm_subnet.subnet-wan.id }
